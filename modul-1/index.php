...
$mhs1->nama = "BIMAS TEGAR SATRIO WIBOWO";
$mhs1->nim = "2310010088";

$mhs2 = new Mahasiswa();
$mhs2->nama = "AHMAD MUAMAR HAMIDAN";
$mhs2->nim = "2310010099";
...
<body>
    ...
    <div class="container">
        ...
        <p class="mt-4">
            <em>(Lihat kode di `Mahasiswa.php` untuk definisi kelas, dan kode di `index.php` untuk cara menggunakannya.)</em>
        </p>

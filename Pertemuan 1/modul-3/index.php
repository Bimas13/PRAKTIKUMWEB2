    ...
    <div class="container">
        ...
        <div class="output">
            ...
            <p>
                <strong>NIM Saat Ini (via Getter):</strong>
                <span style="font-weight: bold; color: #e67e22;">
                    <?php echo $mhs2->getNim(); ?>
                </span>
            </p>
            <p style="color: red;">
                *Objek ini dibuat dengan NIM tidak valid, namun Setter mencegahnya masuk ke properti.
            </p>
        </div>

        <p>
            <em>
                (Coba hapus method <strong>getNim()</strong> dari kode dan akses NIM secara langsung:
                <strong>$mhs1->nim</strong>. Anda akan mendapatkan Fatal Error karena NIM bersifat private!)
            </em>
        </p>

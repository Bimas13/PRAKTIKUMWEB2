...
$user1 = new User("BIMAS TEGAR SATRIO WIBOWO");

// 2. Instansiasi Objek Admin (Kelas Anak)
$admin1 = new Admin("AHMAD MUAMAR HAMIDAN");
?> 
...
<body>
    ...
    <div class="container">
        ...
        <div class="output">
            ...
            <p>Peran yang diwarisi: 
                <span class="role-user">
                    <?php echo $user1->getRole(); ?>
                </span>
            </p>
        </div>
        ...
        <p>
            <em>
                (Perhatikan bahwa objek Admin memiliki metode <strong>salam()</strong> 
                yang berbeda dan tetap dapat menggunakan metode dasar <strong>getRole()</strong> 
                dari kelas User.)
            </em>
        </p>
